...
const Hero = () => {
  return (
    <div className="w-full h-auto pt-[80px] bg-[#FBEBB5] flex flex-col md:flex-row items-center justify-between relative mb-0">
      ...
      <div className="w-full md:w-[750px] h-[500px] md:h-[900px] relative mb-4 md:mb-0">
        <Image
          src="/Rocket single seater 1.png"
          alt="Rocket Single Seater"
          layout="responsive" // Automatically calculates width & height based on aspect ratio
          width={750} // Matches the width of the container
          height={900} // Matches the height of the container
          objectFit="contain" // Prevents cropping and preserves aspect ratio
        />
      </div>
    </div>
  );
